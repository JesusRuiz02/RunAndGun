...
public class StartScene : MonoBehaviour
{
    ...
    private void StartAnimation()
    {
        ...
        playRectTransform.DOAnchorPos(new Vector2(0f, 100f), 2.0f, false).SetEase(Ease.Linear).SetUpdate(true);
        _canvasPlayGroup.DOFade(1, _fadeTime).SetUpdate(true);
       settingsRectTransform.transform.localPosition = new Vector3(-500f, 75f, 0f);
       settingsRectTransform.DOAnchorPos(new Vector2(-250f, 75f), 1.0f, false).SetEase(Ease.Linear).SetUpdate(true);
       creditsRectTransform.transform.localPosition = new Vector3(500f, 75f, 0f);
       creditsRectTransform.DOAnchorPos(new Vector2(250f, 75f), 1.0f, false).SetEase(Ease.Linear).SetUpdate(true);
    }
